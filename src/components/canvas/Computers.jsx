  ...
  return (
    <mesh>
      ...
      <primitive
        ...
        scale={isMobile ? 0.5 : 0.75} // Reduced size for mobile
...
const ComputersCanvas = () => {
  ...
  // Prevent rendering the Canvas if it's a mobile view
...
//       <primitive
//         object={computer.scene}
//         scale={isMobile ? 0.25 : 0.7} // Further reduced scale for mobile
//         position={isMobile ? [0, -1.5, -1] : [0, -3.25, -1.5]} // Adjusted position for mobile
//         rotation={[-0.01, -0.2, -0.1]}
//       />
//     </mesh>
//   );
